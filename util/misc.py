...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler):
    ...
    if loss_scaler is not None:
        checkpoint_paths = [args.model_dir+'/checkpoint-best-'+str(epoch)+'.pth']
        ...
        model.save_checkpoint(save_dir=args.model_dir, tag="checkpoint-best-"+str(epoch), client_state=client_state)
